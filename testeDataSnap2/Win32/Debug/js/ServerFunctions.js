...
function TServerMethods1(connectionInfo)
{
   ...
   * @return result - Type on server: string
   */
  this.getStatusBematech2 = function() {
    var returnObject = this.executor.executeMethod('getStatusBematech2', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.getStatusBematech2_URL = function() {
    return this.executor.getMethodURL("getStatusBematech2", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: string
   */
  this.acionaguilhotina2 = function() {
    var returnObject = this.executor.executeMethod('acionaguilhotina2', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.acionaguilhotina2_URL = function() {
    return this.executor.getMethodURL("acionaguilhotina2", "GET", [], arguments[0])[0];
  };
   ...
   * @return result - Type on server: string
   */
  this.imprimetx = function(Value) {
    var returnObject = this.executor.executeMethod('imprimetx', "GET", [Value], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.imprimetx_URL = function(Value) {
    return this.executor.getMethodURL("imprimetx", "GET", [Value], arguments[1])[0];
  };
   ...
   * @return result - Type on server: string
   */
  this.imprimetx2 = function(Value) {
    var returnObject = this.executor.executeMethod('imprimetx2', "GET", [Value], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.imprimetx2_URL = function(Value) {
    return this.executor.getMethodURL("imprimetx2", "GET", [Value], arguments[1])[0];
  };
   ...
   * @return result - Type on server: string
   */
  this.imprimetx3 = function(Value) {
    var returnObject = this.executor.executeMethod('imprimetx3', "GET", [Value], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.imprimetx3_URL = function(Value) {
    return this.executor.getMethodURL("imprimetx3", "GET", [Value], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["EchoString","ReverseString","getStatusBematech2","acionaguilhotina2","imprimetx","imprimetx2","imprimetx3"]
};
